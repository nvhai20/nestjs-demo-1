...
const product_module_1 = __webpack_require__(22);
...
const user_service_1 = __webpack_require__(15);
const passport_1 = __webpack_require__(18);
const get_user_decorator_1 = __webpack_require__(19);
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "createByUser", null);
__decorate([
...
let UserService = class UserService {
    ...
    async findByEmail(email) {
        ...
        if (!emailDetail) {
            throw new common_1.HttpException('Khong tim thay email', 400);
        }
        console.log(emailDetail);
        return emailDetail;
    }
    async createByUser(email, firstName, lastName, password) {
    ...
    async loginByUser(email, password) {
        try {
            const user = await this.userRepository.findOne({
                where: { email },
            });
            if (!user) {
                throw new common_1.HttpException('Không tìm thấy người dùng', 400);
            }
            const passwordMatch = await bcrypt.compare(password, user.password);
            if (!passwordMatch) {
                throw new common_1.HttpException('Mật khẩu không đúng', 400);
            }
            ...
            throw new common_1.HttpException('Đăng nhập không thành công', 500);
        }
    }
};
...
__decorate([
    (0, typeorm_1.CreateDateColumn)({ default: () => 'CURRENT_TIMESTAMP', nullable: true }),
    __metadata("design:type", typeof (_b = typeof Date !== "undefined" && Date) === "function" ? _b : Object)
], ProductEntity.prototype, "createdAt", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ default: () => 'CURRENT_TIMESTAMP', nullable: true }),
...
__decorate([
    ...
    __metadata("design:type", String),
    __metadata("design:paramtypes", [])
], ProductEntity.prototype, "formattedPrice", null);
...
let ProductController = class ProductController {
    ...
    async getProductById(id) {
        ...
        if (!product) {
            throw new common_1.NotFoundException(`Không tìm thấy sản phẩm ${id}`);
        }
        return product;
    }
...
let ProductService = class ProductService {
    ...
    async updateProduct(id, productData) {
        ...
        if (!product) {
            throw new common_1.HttpException(`Không tìm thấy sản phẩm ${id}`, 404);
        }
        product.name = name;
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("925ec1f7e44b2cec6e0e")
/******/ 	})();
/******/ 	
